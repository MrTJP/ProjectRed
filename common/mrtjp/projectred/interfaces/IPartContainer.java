...
public interface IPartContainer {
	...
	/**
	 * Gets the speed at which a player breaks a part. See
	 ...
	 * 
	 * @param rayTrace
	 *            The location under the player's crosshair.
	 * @param part
	...
	/**
	 * Checks if a given face of this block is solid. Used to determine the
	 * result of Block.isBlockSolidOnSide.
	 */
	...
	/**
	 * Returns all collision boxes that intersect the given mask, in world
	 * coordinates.
	 * 
	 * @param mask
	 *            The mask AABB, in world coordinates.
	 * @param list
	 *            The list to add the returned boxes to.
	 */
	 ...
	 * @param subhit
	 *            The part being broken.
	 * @return The item stacks dropped, or null if none.
	 */
	public List<ItemStack> removePartByPlayer(EntityPlayer ply, int part);

	/**
	 * Returns the AABB of a part, in tile-local coordinates. Currently used for
	 * drawing the selection box. May return null, in which case no selection
	 * box is drawn.
	 * 
	 * @param part
	 *            The part ID to check.
	 * @return The AABB of the part, or null.
	 */
	public AxisAlignedBB getPartAABBFromPool(int part);

	/**
	 * Finds the closest intercept of the given ray with parts in this
	 * container.
	 * 
	 * @param src
	 ...
	 * @return A ray-trace result, or null if the ray does not intersect any
	 *         parts.
	 */
