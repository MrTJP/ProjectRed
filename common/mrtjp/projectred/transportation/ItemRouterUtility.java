...
public class ItemRouterUtility extends Item
{
    ...
    public static RouterUtilContainer createContainer(EntityPlayer player) 
    {        
        RouterUtilContainer container = new RouterUtilContainer(player.inventory);
        
        return container;
    }
    
    public static class RouterUtilContainer extends GhostContainer2
    {
        public SimpleInventory upgradeInv;
        
        private RoutingChipset chip;
        
        public RouterUtilContainer(IInventory playerInv)
        {
            super(playerInv);
        ...
        public void onContainerClosed(EntityPlayer p)
        {
            ...
            upgradeInv.dropContents(p.worldObj, (int)p.posX, (int)p.posY, (int)p.posZ);
        }
