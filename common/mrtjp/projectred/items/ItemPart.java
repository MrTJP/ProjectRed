...
public class ItemPart extends Item {
	...
	public enum EnumPart {
		...
		public static final EmumPart[] RAW_PARTS = { COPPERINGOT, BRASS };
		...
		public static void initOreDictDefinitions() {
			...
			for (EnumPart p : EnumPart.RAW_PARTS) {
				OreDictionary.registerOre(oreDictDefinition_raw, p.getItemStack());
			}
		}
