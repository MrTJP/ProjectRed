...
public enum EnumWire {
    ...
    RED_ALLOY("Red alloy wire", "pr_redwire", "pr_fredwire", 0, 0xC80000, "redalloy"),
    
    INSULATED_0("White insulated wire", "pr_insulated", "pr_finsulated", 1, 0xFFFFFF, "insulated/whiteoff", "insulated/whiteon"),
    INSULATED_1("Orange insulated wire", "pr_insulated", "pr_finsulated", 1, 0xFFFFFF, "insulated/orangeoff", "insulated/orangeon"),
    INSULATED_2("Magenta insulated wire", "pr_insulated", "pr_finsulated", 1, 0xFFFFFF, "insulated/magentaoff", "insulated/magentaon"),
    INSULATED_3("Light blue insulated wire", "pr_insulated", "pr_finsulated", 1, 0xFFFFFF, "insulated/lightblueoff", "insulated/lightblueon"),
    INSULATED_4("Yellow insulated wire", "pr_insulated", "pr_finsulated", 1, 0xFFFFFF, "insulated/yellowoff", "insulated/yellowon"),
    INSULATED_5("Lime insulated wire", "pr_insulated", "pr_finsulated", 1, 0xFFFFFF, "insulated/limeoff", "insulated/limeon"),
    INSULATED_6("Pink insulated wire", "pr_insulated", "pr_finsulated", 1, 0xFFFFFF, "insulated/pinkoff", "insulated/pinkon"),
    INSULATED_7("Grey insulated wire", "pr_insulated", "pr_finsulated", 1, 0xFFFFFF, "insulated/greyoff", "insulated/greyon"),
    INSULATED_8("Light grey insulated wire", "pr_insulated", "pr_finsulated", 1, 0xFFFFFF, "insulated/lightgreyoff", "insulated/lightgreyon"),
    INSULATED_9("Cyan insulated wire", "pr_insulated", "pr_finsulated", 1, 0xFFFFFF, "insulated/cyanoff", "insulated/cyanon"),
    INSULATED_10("Purple insulated wire", "pr_insulated", "pr_finsulated", 1, 0xFFFFFF, "insulated/purpleoff", "insulated/purpleon"),
    INSULATED_11("Blue insulated wire", "pr_insulated", "pr_finsulated", 1, 0xFFFFFF, "insulated/blueoff", "insulated/blueon"),
    INSULATED_12("Brown insulated wire", "pr_insulated", "pr_finsulated", 1, 0xFFFFFF, "insulated/brownoff", "insulated/brownon"),
    INSULATED_13("Green insulated wire", "pr_insulated", "pr_finsulated", 1, 0xFFFFFF, "insulated/greenoff", "insulated/greenon"),
    INSULATED_14("Red insulated wire", "pr_insulated", "pr_finsulated", 1, 0xFFFFFF, "insulated/redoff", "insulated/redon"),
    INSULATED_15("Black insulated wire", "pr_insulated", "pr_finsulated", 1, 0xFFFFFF, "insulated/blackoff", "insulated/blackon"),

    BUNDLED_N("Bundled cable", "pr_bundled", "pr_fbundled", 2, 0xFFFFFF, "bundled/neutral"),
