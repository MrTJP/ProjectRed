...
public enum EnumSpecialTool {
    ...
    RUBYSAW("Ruby Saw", "sawruby", ProjectRed.toolMaterialRuby, EnumPart.RUBY.getItemStack()),
    SAPPHIRESAW("Sapphire Saw", "sawsapphire", ProjectRed.toolMaterialSapphire, EnumPart.SAPPHIRE.getItemStack()),
    PERIDOTSAW("Peridot Saw", "sawperidot", ProjectRed.toolMaterialPeridot, EnumPart.PERIDOT.getItemStack()),
    ...
    RUBYSICKLE("Ruby Sickle", "sickleruby", ProjectRed.toolMaterialRuby, EnumPart.RUBY.getItemStack()),
    SAPPHIRESICKLE("Sapphire Sickle", "sicklesapphire", ProjectRed.toolMaterialSapphire, EnumPart.SAPPHIRE.getItemStack()),
    PERIDOTSICKLE("Peridot Sickle", "sickleperidot", ProjectRed.toolMaterialPeridot, EnumPart.PERIDOT.getItemStack()),
