 ...
 * Link-State path finding, which is used to establish a connection from
 * one routed pipe to another. This is registered through the ProjectRedAPI.
 */
public interface ISpecialLinkState
{
     ...
     * 
     * The given tile is what the pipes found, the returned list is what the pipe
     * should consider as found.
     * 
     * @param te The tile in question. 
     * @return A list of all connected pipes (as tiles, should be TileMultipart).
     * This MUST be null if there are no connections of this special type.
     */
