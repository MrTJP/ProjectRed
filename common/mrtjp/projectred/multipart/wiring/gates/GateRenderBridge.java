...
/**
 * Gate renderings provides a bridge between a gate's bitmasked renderstate to
 * the renderer. Each time a rendering is checked, it gets a bitmask from the
 * actual gate, and sets all the states of the torches, pointers, etc. Then, the
 * GateDynamicRenderer renders things that are common in all gates, like torches
 * and pointers. Then, the gate rendering is asked if there is something it
 * wants to render specail just for that gate, like bundled cabling or levers.
 * attached to them.
 * 
 * @author MrTJP
 * 
...
public abstract class GateRenderBridge {
	...
	public int[] wireColor = new int[] { 0xFF0000 };
	...
	public static GatePartModel _torchOn = new GatePartModel(_torchOff.getCCModels(), "torch.obj", "redtorchon.png");
	public static GatePartModel _greenTorchOff = new GatePartModel(_torchOff.getCCModels(), "torch.obj", "greentorchoff.png");
	public static GatePartModel _greenTorchOn = new GatePartModel(_torchOff.getCCModels(), "torch.obj", "greentorchon.png");
	public static GatePartModel _wire = new GatePartModel("wire.obj", "wire.png");
	...
	public static class AND extends GateRenderBridge implements Stateless {
		{
			...
			wirePosX = new float[][] { { 5, 6, 7, 8, 9, 10, 11, 12 }, { 8.5f, 8.5f, 8.5f, 8.5f, 8.5f, 8.5f, 8.5f, 8.5f, 8.5f }, { 12.5f, 12.5f, 12.5f, 13, 14, 15 }, { 4.5f, 4.5f, 4.5f, 4, 3, 2 } };
			wirePosZ = new float[][] { { 5, 5, 5, 5, 5, 5, 5, 5 }, { 7, 8, 9, 10, 11, 12, 13, 14, 15 }, { 7, 8, 8.5f, 8.5f, 8.5f, 8.5f }, { 7, 8, 8.5f, 8.5f, 8.5f, 8.5f } };
			wireColor = new int[] { 0, 0, 0, 0 };
			torchX = new float[] { 8.5f, 4.5f, 8.5f, 12.5f };
			torchY = new float[] { 0f, 0f, 0f, 0f };
			torchZ = new float[] { 2.25f, 6.25f, 6.25f, 6.25f };
	...
	public static class OR extends GateRenderBridge implements Stateless {
		{
			...
			wireColor = new int[] { 0xFFFFFF, 0, 0, 0, 0, 0xFF0000 };
		...
		@Override
		public void set(int renderState) {
			wireColor[1] = (renderState & 1) != 0 ? ON : OFF;
			wireColor[2] = (renderState & 64) != 0 ? DISABLED : (renderState & 2) != 0 ? ON : OFF;
			wireColor[3] = (renderState & 128) != 0 ? DISABLED : (renderState & 8) != 0 ? ON : OFF;
			wireColor[4] = (renderState & 32) != 0 ? DISABLED : (renderState & 4) != 0 ? ON : OFF;
			wireColor[5] = (renderState & 1) == 0 ? ON : OFF;
	...
	public static class NOT extends GateRenderBridge implements Stateless {
		{
			...
			wireColor = new int[] { 0xFFFFFF, 0, 0, 0, 0 };
		...
		@Override
		public void set(int renderState) {
			wireColor[1] = (renderState & 64) != 0 ? DISABLED : (renderState & 1) != 0 ? ON : OFF;
		...
		@Override
		public void setItemRender() {
			wireColor[1] = wireColor[3] = wireColor[4] = ON;
			wireColor[2] = OFF;
			torchState[0] = true;
		}
	}
	...
	public static class RSLatch extends GateRenderBridge implements Stateless {
		{
			...
			wireColor = new int[] { 0xFFFFFF, 0, 0 };
	...
	public static class NAND extends GateRenderBridge implements Stateless {
		...
		public void set(int renderState) {
			...
			boolean right_disabled = (renderState & 64) != 0;
			wireColor[1] = (renderState & 1) != 0 ? ON : OFF;
			wireColor[2] = back_disabled ? DISABLED : (renderState & 2) != 0 ? ON : OFF;
			wireColor[3] = right_disabled ? DISABLED : (renderState & 8) != 0 ? ON : OFF;
			wireColor[4] = left_disabled ? DISABLED : (renderState & 4) != 0 ? ON : OFF;
	...
	public static class XNOR extends GateRenderBridge implements Stateless {
		{
			...
			wireColor = new int[] { 0xFFFFFF, 0, 0, 0, 0, 0 };
	...
	public static class Buffer extends GateRenderBridge implements Stateless {
		...
		public void set(int renderState) {
			...
			wireColor[4] = (renderState & 2) == 0 ? ON : OFF;
	...
	public static class Multiplexer extends GateRenderBridge implements Stateless {
		{
			...
			wireColor = new int[] { 0xFFFFFF, 0, 0, 0, 0, 0, 0 };
		...
		public void set(int renderState) {
			...
			wireColor[1] = back ? ON : OFF;
			wireColor[2] = left ? ON : OFF;
			wireColor[3] = right ? ON : OFF;
			wireColor[4] = !back ? ON : OFF;
			wireColor[5] = !left && back ? ON : OFF;
			wireColor[6] = !right && !back ? ON : OFF;
			torchState[0] = out;
	...
	public static class Timer extends GateRenderBridge implements Stateless {
		{
			...
			wireColor = new int[] { 0xFFFFFF, 0, 0, 0 };
			torchX = new float[] { 8f };
			torchY = new float[] { 0f };
			torchZ = new float[] { 2f };
			torchState = new boolean[] { false };
	...
	public static class PulseFormer extends GateRenderBridge implements Stateless {
		...
		public void set(int renderState) {
			...
			wireColor[1] = in ? ON : OFF;
			wireColor[2] = in ? OFF : ON;
			wireColor[3] = in ? OFF : ON;
			wireColor[4] = /* in && !out */torchState[2] ? ON : OFF;
		}
	...
	public static class StateCell extends GateRenderBridge implements Stateless {
		...
		public void set(int renderState) {
			wireColor[1] = (renderState & 1) != 0 ? ON : OFF;
			wireColor[2] = (renderState & 2) != 0 ? ON : OFF;
			wireColor[3] = (renderState & 4) != 0 ? ON : OFF;
			wireColor[4] = (renderState & 16) == 0 ? ON : OFF;
			wireColor[5] = (renderState & 16) != 0 ? ON : OFF;
			wireColor[6] = (renderState & 8) != 0 ? ON : OFF;
			torchState[0] = (renderState & 8) != 0;
		}
	...
	public static class Synchronizer extends GateRenderBridge implements Stateless {
		...
		public void set(int renderState) {
			...
			wireColor[3] = (renderState & 4) != 0 ? ON : OFF;
			torchState[0] = (renderState & 8) != 0;
			wireColor[4] = (renderState & 48) != 0 ? ON : OFF;
			wireColor[5] = (renderState & 16) != 0 ? OFF : ON;
			wireColor[6] = (renderState & 32) != 0 ? OFF : ON;
		}
