...
import static mrtjp.projectred.multipart.microblocks.EnumAxisPosition.Negative;
import static mrtjp.projectred.multipart.microblocks.EnumAxisPosition.Positive;
import static mrtjp.projectred.multipart.microblocks.EnumAxisPosition.Span;
import static mrtjp.projectred.multipart.microblocks.EnumPositionClass.Corner;
...
public enum EnumPosition {
	...
	private static EnumPosition edgePositionLookup[][] = { { null, null, EdgeNYNZ, EdgeNYPZ, EdgeNXNY, EdgePXNY }, { null, null, EdgePYNZ, EdgePYPZ, EdgeNXPY, EdgePXPY }, { EdgeNYNZ, EdgePYNZ, null, null, EdgeNXNZ, EdgePXNZ }, { EdgeNYPZ, EdgePYPZ, null, null, EdgeNXPZ, EdgePXPZ }, { EdgeNXNY, EdgeNXPY, EdgeNXNZ, EdgeNXPZ, null, null }, { EdgePXNY, EdgePXPY, EdgePXNZ, EdgePXPZ, null, null }, };
	...
	/**
	 * Returns the edge microblock position that intersects both the given
	 * faces.
	 * 
	 * @param side1
	 *            One of the faces.
	 * @param side2
	 *            The other face.
	 * @return The matching microblock position, or null for invalid face
	 *         combinations (eg +Y and -Y)
	 */
