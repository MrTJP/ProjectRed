...
public abstract class WireTile extends BaseTile implements IConnectableICTile {
    ...
    public void renderTile(CCRenderState ccrs, Transformation t, float partialFrame) {
        ...
        int modelKey = WireModelRenderer.modelKey(0, getWireType().getThickness(), wireConnMask);
        WireModelRenderer.render(ccrs, modelKey, getRenderHue(), getWireType().getTextures().get(getTextureIndex()), t);
    }
}
