...
object IntegrationContent
{
    ...
    val partOrGate = PARTS.register("or_gate", newPartTypeSupplierForFactory(() => new OR))
    val partNorGate = PARTS.register("nor_gate", newPartTypeSupplierForFactory(() => new NOR))
    val partNotGate = PARTS.register("not_gate", newPartTypeSupplierForFactory(() => new NOT))
    val partAndGate = PARTS.register("and_gate", newPartTypeSupplierForFactory(() => new AND))
    val partNandGate = PARTS.register("nand_gate", newPartTypeSupplierForFactory(() => new NAND))
    val partXorGate = PARTS.register("xor_gate", newPartTypeSupplierForFactory(() => new XOR))
    val partXnorGate = PARTS.register("xnor_gate", newPartTypeSupplierForFactory(() => new XNOR))
    val partBufferGate = PARTS.register("buffer_gate", newPartTypeSupplierForFactory(() => new Buffer))
    val partMultiplexerGate = PARTS.register("multiplexer_gate", newPartTypeSupplierForFactory(() => new Multiplexer))
    val partPulseGate = PARTS.register("pulse_gate", newPartTypeSupplierForFactory(() => new Pulse))
    val partRepeaterGate = PARTS.register("repeater_gate", newPartTypeSupplierForFactory(() => new Repeater))
    val partRandomizerGate = PARTS.register("randomizer_gate", newPartTypeSupplierForFactory(() => new Randomizer))
    val partSrLatchGate = PARTS.register("sr_latch_gate", newPartTypeSupplierForFactory(() => new SRLatch))
    val partToggleLatchGate = PARTS.register("toggle_latch_gate", newPartTypeSupplierForFactory(() => new ToggleLatch))
    val partTransparentLatchGate = PARTS.register("transparent_latch_gate", newPartTypeSupplierForFactory(() => new TransparentLatch))
    val partLightSensorGate = PARTS.register("light_sensor_gate", newPartTypeSupplierForFactory(() => new LightSensor))
    val partRainSensorGate = PARTS.register("rain_sensor_gate", newPartTypeSupplierForFactory(() => new RainSensor))
    val partTimerGate = PARTS.register("timer_gate", newPartTypeSupplierForFactory(() => new Timer))
    val partSequencerGate = PARTS.register("sequencer_gate", newPartTypeSupplierForFactory(() => new Sequencer))
    val partCounterGate = PARTS.register("counter_gate", newPartTypeSupplierForFactory(() => new Counter))
    val partStateCellGate = PARTS.register("state_cell_gate", newPartTypeSupplierForFactory(() => new StateCell))
    val partSynchronizerGate = PARTS.register("synchronizer_gate", newPartTypeSupplierForFactory(() => new Synchronizer))
    val partBusTransceiverGate = PARTS.register("bus_transceiver_gate", newPartTypeSupplierForFactory(() => new BusTransceiver))
    val partNullCellGate = PARTS.register("null_cell_gate", newPartTypeSupplierForFactory(() => new NullCell))
    val partInvertCellGate = PARTS.register("invert_cell_gate", newPartTypeSupplierForFactory(() => new InvertCell))
    val partBufferCellGate = PARTS.register("buffer_cell_gate", newPartTypeSupplierForFactory(() => new BufferCell))
    val partComparatorGate = PARTS.register("comparator_gate", newPartTypeSupplierForFactory(() => new Comparator))
    val partAndCellGate = PARTS.register("and_cell_gate", newPartTypeSupplierForFactory(() => new ANDCell))
    val partBusRandomizerGate = PARTS.register("bus_randomizer_gate", newPartTypeSupplierForFactory(() => new BusRandomizer))
    val partBusConverterGate = PARTS.register("bus_converter_gate", newPartTypeSupplierForFactory(() => new BusConverter))
    val partBusInputPanelGate = PARTS.register("bus_input_panel_gate", newPartTypeSupplierForFactory(() => new BusInputPanel))
    val partStackingLatchGate = PARTS.register("stacking_latch_gate", newPartTypeSupplierForFactory(() => new StackingLatch))
    val partSegmentDisplayGate = PARTS.register("segment_display_gate", newPartTypeSupplierForFactory(() => new SegmentDisplay))
    val partDecRandomizerGate = PARTS.register("dec_randomizer_gate", newPartTypeSupplierForFactory(() => new DecodingRand))
