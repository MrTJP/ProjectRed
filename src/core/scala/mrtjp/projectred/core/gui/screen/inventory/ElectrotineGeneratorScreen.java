...
public class ElectrotineGeneratorScreen extends RedUIContainerScreen<ElectrotineGeneratorContainer> implements IHasContainer<ElectrotineGeneratorContainer> {
    ...
    public static final ResourceLocation BACKGROUND = new ResourceLocation(ProjectRedCore.MOD_ID(), "textures/gui/electrotine_generator.png");
    ...
    public void drawBack(MatrixStack stack, Point mouse, float partialFrame) {
        ...
        // Charge Bar
        GuiLib$.MODULE$.drawVerticalTank(stack, this, x + 22, y + 26, 176, 10, 7, 48, getMenu().getChargeScaled(48));
        ...
        // Storage Bar
        GuiLib$.MODULE$.drawVerticalTank(stack, this, x + 54, y + 26, 184, 10, 14, 48, getMenu().getPowerStoredScaled(48));
        ...
        // Burning Bar
        GuiLib$.MODULE$.drawVerticalTank(stack, this, x + 93, y + 26, 199, 10, 7, 48, getMenu().getBurnTimeScaled(48));
