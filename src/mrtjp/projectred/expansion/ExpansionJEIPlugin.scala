...
class ExpansionJEIPlugin extends BlankModPlugin
{
    ...
    {
        //Inductive furnace
        registry.addRecipeCategoryCraftingItem(new ItemStack(machine1, 1, 0), SMELTING)
        ...
        //Project bench
        registry.addRecipeCategoryCraftingItem(new ItemStack(machine2, 1, 10), CRAFTING)
        ...
        //Auto crafting table
        registry.addRecipeCategoryCraftingItem(new ItemStack(machine2, 1, 11), CRAFTING) //auto crafting bench
    }
