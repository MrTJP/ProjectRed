...
import mrtjp.projectred.core.libmc.world.Replacement.Replacement
...
class BlockTypeWood extends BlockType(Blocks.air,0)
{
    override def setBlock(world:World, tree:ITreeGenData, x:Int, y:Int, z:Int) = tree.setWood(world, x, y, z)
}

class BlockTypeLeaf extends BlockType(Blocks.air,0)
{
...
abstract class GeneratorTreeBase(var tree:ITreeGenData) extends WorldGenCore
{
    ...
    var vine:BlockType = new BlockType(Blocks.vine, 0)
