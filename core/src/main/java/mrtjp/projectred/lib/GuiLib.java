...
public class GuiLib {
    ...
    public static void drawVerticalTank(MatrixStack stack, AbstractGui gui, int x, int y, int u, int v, int w, int h, int prog) {
        gui.blit(stack, x, y + h - prog, u, v + h - prog, w, prog);
    }

    public static void drawLine(MatrixStack stack, int x1, int y1, int x2, int y2, int th, int argb) {
